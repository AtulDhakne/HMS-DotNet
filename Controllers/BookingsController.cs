...
namespace HMS.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Name,Phone,Diseases,Age,Gender,Address,BookingDate")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Name,Phone,Diseases,Age,Gender,Address,BookingDate")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
